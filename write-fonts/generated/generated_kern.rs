...
impl FontWrite for Kern {
    ...
    fn write_into(&self, writer: &mut TableWriter) {
        ...
        (array_len(&self.subtables).unwrap() as u16).write_into(writer);
...
impl Kern0 {
    ...
    pub fn new(
        ...
        Self {
            ...
            entry_selector,
            range_shift,
            kerning_pairs: kerning_pairs.into_iter().map(Into::into).collect(),
        }
    }
}
...
impl FontWrite for Kern0 {
    ...
    fn write_into(&self, writer: &mut TableWriter) {
        ...
        (array_len(&self.kerning_pairs).unwrap() as u16).write_into(writer);
