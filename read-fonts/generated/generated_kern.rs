...
impl KernMarker {
    ...
    fn subtables_byte_range(&self) -> Range<usize> {
...
impl Kern0Marker {
    ...
    fn coverage_byte_range(&self) -> Range<usize> {
        let start = self.length_byte_range().end;
        start..start + KernCoverage::RAW_BYTE_LEN
    }
    fn num_pairs_byte_range(&self) -> Range<usize> {
    ...
    fn kerning_pairs_byte_range(&self) -> Range<usize> {
